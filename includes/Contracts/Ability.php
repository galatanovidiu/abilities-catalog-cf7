...
namespace GalatanOvidiu\AbilitiesCatalogCf7\Contracts;
 ...
 *
 * One class per ability, one file per class, discovered by {@see \GalatanOvidiu\AbilitiesCatalogCf7\Registry}
 ...
 * {@see CategoryProvider} (e.g. `\GalatanOvidiu\AbilitiesCatalogCf7\Abilities\Core\CategoryCatalog`);
