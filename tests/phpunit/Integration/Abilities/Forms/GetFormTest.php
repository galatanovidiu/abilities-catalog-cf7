<?php
/**
 * Integration tests for the cf7/get-form ability.
 *
...
/**
 * Exercises cf7/get-form: full configuration, the gap-closing shortcode/hash, and
...
final class GetFormTest extends Cf7FormsTestCase {
	...
	public function test_ability_is_registered(): void {
		$ability = wp_get_ability( 'cf7/get-form' );

		$this->assertNotNull( $ability );
		$this->assertSame( 'cf7/get-form', $ability->get_name() );
	}
	...
	public function test_admin_reads_form_with_shortcode_and_properties(): void {
		...
		$result = wp_get_ability( 'cf7/get-form' )->execute( array( 'id' => $id ) );
	...
	public function test_missing_form_returns_404_not_permission_error(): void {
		...
		$result = wp_get_ability( 'cf7/get-form' )->execute( array( 'id' => 99999999 ) );
