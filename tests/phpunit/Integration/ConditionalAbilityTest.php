...
namespace GalatanOvidiu\AbilitiesCatalogCf7\Tests\Integration;

use GalatanOvidiu\AbilitiesCatalogCf7\Registry;
use GalatanOvidiu\AbilitiesCatalogCf7\Tests\Fixtures\UnavailableConditionalAbility;
